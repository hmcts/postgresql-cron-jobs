...
AZURE_HOSTNAME="dm-store-postgres-db-prod.postgres.database.azure.com"
AZURE_DB_USERNAME="evidence@dm-store-postgres-db-prod"
AZURE_DB="evidence"

# Location to place backups
backup_dir="/backups/EVIDENCE/"
...
pg_dump -Fc -T documentcontent -U ${AZURE_DB_USERNAME} -h ${AZURE_HOSTNAME}  -d ${AZURE_DB} | gzip > $backupfile > $backupfile

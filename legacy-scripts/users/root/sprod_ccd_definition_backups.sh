...
AZURE_HOSTNAME="ccd-definition-store-api-postgres-db-sprod.postgres.database.azure.com"
AZURE_DB_USERNAME="ccd@ccd-definition-store-api-postgres-db-sprod"
AZURE_DB="ccd_definition_store"

# Location to place backups
backup_dir="/backups/SCCD/"

...
AZURE_HOSTNAME="dm-store-postgres-db-sprod.postgres.database.azure.com"
AZURE_DB_USERNAME="evidence@dm-store-postgres-db-sprod"
AZURE_DB="evidence"

# Location to place backups
backup_dir="/backups/SEVIDENCE/"

...
OUTPUT_FILE_NAME=CCD-FR_EXCEPTIONS-Initial-${RUNTODAY}.csv
...
echo -e "" | mail -s "FR Exceptions One-off dumps complete " -a ${OUTPUT_DIR}/COMPLETE.txt -r $FROM_ADDRESS ${TO_ADDRESS}  

...
OUTPUT_FILE_NAME=CCD-PROBATE-CAVEATS-Initial-${RUNTODAY}.csv
...
echo -e "" | mail -s "PROBATE-CAVEATS One-off dumps complete " -a ${OUTPUT_DIR}/COMPLETE.txt -r $FROM_ADDRESS ${TO_ADDRESS}  

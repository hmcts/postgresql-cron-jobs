...
OUTPUT_FILE_NAME=CCD-MONEYCLAIMS-Initial-${RUNTODAY}.csv
...
echo -e "" | mail -s "MONEYCLAIMS One-off dumps complete " -a ${OUTPUT_DIR}/COMPLETE.txt -r $FROM_ADDRESS ${TO_ADDRESS}  

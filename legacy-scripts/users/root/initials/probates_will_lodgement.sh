...
OUTPUT_FILE_NAME=CCD-PROBATE-WILLLODGEMENT-Initial-${RUNTODAY}.csv
...
echo -e "" | mail -s "PROBATE-WILLLODGEMENT One-off dumps complete " -a ${OUTPUT_DIR}/COMPLETE.txt -r $FROM_ADDRESS ${TO_ADDRESS}  

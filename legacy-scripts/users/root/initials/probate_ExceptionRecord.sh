...
OUTPUT_FILE_NAME=CCD-PROBATE-ExceptionRecord-Initial-${RUNTODAY}.csv
...
echo -e "" | mail -s "PROBATE-ExceptionRecord One-off dumps complete " -a ${OUTPUT_DIR}/COMPLETE.txt -r $FROM_ADDRESS ${TO_ADDRESS}  

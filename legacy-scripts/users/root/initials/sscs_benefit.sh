...
OUTPUT_FILE_NAME=CCD-SSCS-BENEFIT-Initial-${RUNTODAY}.csv
...
echo -e "" | mail -s "SSCS-BENEFIT One-off dumps complete " -a ${OUTPUT_DIR}/COMPLETE.txt -r $FROM_ADDRESS ${TO_ADDRESS}  

...
AZURE_HOSTNAME="probate-persistence-service-postgres-db-prod.postgres.database.azure.com"
AZURE_DB_USERNAME="probate@probate-persistence-service-postgres-db-prod"
AZURE_DB="probate"

# Location to place backups
backup_dir="/backups/PROBATE/"

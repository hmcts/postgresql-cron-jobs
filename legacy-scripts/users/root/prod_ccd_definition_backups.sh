...
AZURE_HOSTNAME="ccd-definition-store-api-postgres-db-v11-prod.postgres.database.azure.com"
AZURE_DB_USERNAME="ccd@ccd-definition-store-api-postgres-db-v11-prod"

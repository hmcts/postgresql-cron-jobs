...
AZURE_HOSTNAME="fees-register-postgres-db-prod.postgres.database.azure.com"
AZURE_DB_USERNAME="fees_register@fees-register-postgres-db-prod"
AZURE_DB="fees_register"

# Location to place backups
backup_dir="/backups/FEESREGISTER/"

...
pg_dump  -v -Fd -j 8 -a -T case_event --compress=0 -U ${AZURE_DB_USERNAME} -h ${AZURE_HOSTNAME}  -d ${AZURE_DB} -f $backupfile
date > $backup_dir/end_time

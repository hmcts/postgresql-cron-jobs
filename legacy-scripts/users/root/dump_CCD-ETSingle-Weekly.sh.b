...
OUTPUT_DIR=/tmp
OUTPUT_FILE_NAME=CCD-ETSingle-Weekly_${DEFAULT_DATE}.csv
...
trim(CE.data ->>'state') AS ce_case_state,
...
echo -e "Hi\nPlease find attached CCD-ETSingle-Weekly report for ${DEFAULT_DATE}." | mail -s "CCD-ETSingle-Weekly Reporting" -a ${OUTPUT_DIR}/${OUTPUT_FILE_NAME} -r $FROM_ADDRESS ${TO_ADDRESS} 

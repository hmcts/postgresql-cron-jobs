...
## Weekly Probate Extract for the DwP 
## Extraction is from CCD - core_case_data DB
# JIRA - https://tools.hmcts.net/jira/browse/PRO-5396 & https://tools.hmcts.net/confluence/display/PRO/DWP+Extract
# Alliu Balogun - 21/05/2019
# 
...
echo -e "Probate extract from MoJ to the DwP" | mail -s "MoJ feed to the DwP" -a ${OUTPUT_DIR}/${OUTPUT_FILE_NAME}.zip -r $FROM_ADDRESS ${TO_ADDRESS} ${CC_ADDRESS} ALAN.J.BARKER@DWP.GOV.UK

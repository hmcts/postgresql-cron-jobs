...
sftp -P ${BAIS_SFTP_SERVER_PORT} -i ${ID_FILEPATH} -oStrictHostKeyChecking=accept-new -oHostKeyAlgorithms=+ssh-rsa ${BAIS_SFTP_SERVER_USERNAME}@${BAIS_SFTP_SERVER} <<EOF
put ${OUTPUT_FILEPATH}
bye
EOF

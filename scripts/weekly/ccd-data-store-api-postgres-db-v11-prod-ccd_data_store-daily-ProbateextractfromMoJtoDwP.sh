...
YESTERDAY=$(date -d "17 days ago" '+%Y-%m-%d')
SEVENDAYSAGO=$(date -d "24 days ago" '+%Y-%m-%d')
DWPYESTERDAY=$(date -d "17 days ago" '+%Y%m%d')
DWPSEVENDAYSAGO=$(date -d "24 days ago" '+%Y%m%d')
CREATEDYESTERDAY=$(date -d "17 days ago" '+%Y-%m-%d 00:00:00.00000')
CREATEDSEVENDAYSAGO=$(date -d "24 days ago" '+%Y-%m-%d 23:59:59.99999')
